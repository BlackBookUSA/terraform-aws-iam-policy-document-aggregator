locals {
  ...
  policies = [
    length(local.source_documents) > 1 ? local.source_documents[1] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 2 ? local.source_documents[2] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 3 ? local.source_documents[3] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 4 ? local.source_documents[4] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 5 ? local.source_documents[5] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 6 ? local.source_documents[6] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 7 ? local.source_documents[7] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 8 ? local.source_documents[8] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 9 ? local.source_documents[9] : data.aws_iam_policy_document.empty.json,
    length(local.source_documents) > 10 ? local.source_documents[10] : data.aws_iam_policy_document.empty.json,
  ]
}
